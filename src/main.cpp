...
int main(int, char **) {//argc,argv are required to avoid SDL_main conflict
    initWindow();
    return 0;
}
...
int initWindow() {
    ...
    SDL_Window *window = SDL_CreateWindow("ImguiDemoCLion", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
